    ...
    >
      ...
      >
        <div class="mb-3.5 flex items-center gap-3">
          ...
          <h2 class="m-0 text-[0.95rem]">Delete '{{ bookToDelete?.name }}'?</h2>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            class="rounded-full border border-[#6553281f] bg-[#fffdfa] px-3.5 py-2.5 text-center font-bold text-[#5d4930]"
            type="button"
            @click="showDeleteConfirmation = false"
          >
            Cancel
          ...
          <button
            class="rounded-full border-0 bg-[#c23c37] px-3.5 py-2.5 text-center font-bold text-[#fff8ea] shadow-[0_12px_24px_rgba(194,60,55,0.18)]"
            type="button"

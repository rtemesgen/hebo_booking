<template>
  <main class="mx-auto grid w-full max-w-[430px] gap-2.5 px-2.5 pb-24 pt-2.5">
    ...
    >
      ...
      >
        <div class="mb-4">
          <h2 id="delete-confirm-title" class="m-0 text-[1rem] text-[#342716]">
            Delete '{{ bookToDelete?.name }}'?
          </h2>
          <p class="mt-2 text-[0.85rem] text-[#7a715f]">
        ...
        <div class="grid gap-2">
          <button
            class="w-full rounded-full border-0 bg-[#c23c37] px-3.5 py-2.5 font-bold text-white shadow-[0_12px_24px_rgba(194,60,55,0.18)]"
            type="button"
          ...
          <button
            ...
            class="w-full rounded-full border border-[#6553281f] bg-[#fffdfa] px-3.5 py-2.5 font-bold text-[#5d4930]"
            type="button"
            @click="closeDeleteConfirmSheet"
          >
            Cancel

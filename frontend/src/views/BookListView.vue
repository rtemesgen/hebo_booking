<template>
  <main class="mx-auto grid w-full max-w-[430px] gap-2.5 px-2.5 pb-24 pt-2.5">
    ...
    <div v-if="showSearchSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="showSearchSheet = false">
      <section class="w-full max-w-[430px] rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-3.5 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close search" type="button" @click="showSearchSheet = false">x</button>
    ...
    <div v-if="showSortSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="showSortSheet = false">
      <section class="w-full max-w-[430px] rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-3.5 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close sorting" type="button" @click="showSortSheet = false">x</button>
    ...
    <div v-if="showBusinessSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="closeBusinessSheet">
      <section class="w-full max-w-[430px] rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-3.5 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close business selection" type="button" @click="closeBusinessSheet">x</button>
    ...
    <div v-if="showAddBusinessSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="closeAddBusinessSheet">
      <section class="w-full max-w-[430px] rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-3.5 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close add business" type="button" @click="closeAddBusinessSheet">x</button>
    ...
    <div v-if="showAddBookSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="closeAddBookSheet">
      <section class="w-full max-w-[430px] rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-3.5 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close add book" type="button" @click="closeAddBookSheet">x</button>
    ...
    <div v-if="showRenameSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="closeRenameSheet">
      <section class="w-full max-w-[430px] rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-3.5 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close rename book" type="button" @click="closeRenameSheet">x</button>
    ...
    <div v-if="showInviteSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" @click="closeInviteSheet">
      <section class="grid w-full max-w-[430px] gap-4 rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-3 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="mb-1 flex items-center gap-3">
          <button class="border-0 bg-transparent text-2xl text-[#5d4930]" aria-label="Close invite" type="button" @click="closeInviteSheet">x</button>
    ...
    <div v-if="showDeleteConfirmSheet" class="fixed inset-0 z-20 flex items-end justify-center bg-[rgba(27,31,44,0.45)]" role="alertdialog" aria-modal="true" aria-labelledby="delete-confirm-title" @click="closeDeleteConfirmSheet">
      <section class="grid w-full max-w-[430px] gap-4 rounded-t-2xl bg-[rgba(255,252,244,0.98)] p-4 shadow-[0_-10px_40px_rgba(82,61,20,0.18)]" @click.stop>
        <div class="text-center">
          <h2 id="delete-confirm-title" class="mb-2 mt-0 text-lg font-bold text-[#342716]">Delete this book?</h2>
          <p class="mb-6 mt-0 text-[0.85rem] text-[#7a715f]">
            This will permanently remove <strong>{{ bookToDelete?.name }}</strong> and all its records. This action cannot be undone.
          </p>
        </div>

        <div class="grid gap-3">
          <button class="w-full rounded-full border-0 bg-[#c23c37] py-3 font-bold text-white shadow-lg" type="button" @click="confirmDeleteBook">
            Delete Book
          </button>
          <button class="w-full rounded-full border border-[#6553281f] bg-transparent py-3 font-bold text-[#5d4930]" type="button" @click="closeDeleteConfirmSheet">
            Cancel
          </button>
        </div>
      </section>
...
async function confirmDeleteBook() {
  ...
  const removed = await booksStore.removeBook(bookId)
  if (!removed) {
